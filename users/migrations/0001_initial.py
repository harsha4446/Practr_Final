# -*- coding: utf-8 -*-
# Generated by Django 1.10.6 on 2017-07-26 18:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data1', models.FileField(blank=True, null=True, upload_to=users.models.round_data)),
                ('data2', models.FileField(blank=True, null=True, upload_to=users.models.round_data)),
                ('data3', models.FileField(blank=True, null=True, upload_to=users.models.round_data)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('about', models.CharField(blank=True, default='', max_length=60000)),
                ('task1', models.CharField(blank=True, default='', max_length=500)),
                ('task2', models.CharField(blank=True, default='', max_length=500)),
                ('tast3', models.CharField(blank=True, default='', max_length=500)),
                ('task4', models.CharField(blank=True, default='', max_length=500)),
                ('task5', models.CharField(blank=True, default='', max_length=500)),
                ('resource1', models.CharField(blank=True, default='', max_length=200)),
                ('resource2', models.CharField(blank=True, default='', max_length=200)),
                ('resource3', models.CharField(blank=True, default='', max_length=200)),
                ('resource4', models.CharField(blank=True, default='', max_length=200)),
                ('resource5', models.CharField(blank=True, default='', max_length=200)),
                ('resource1data', models.FileField(blank=True, null=True, upload_to=users.models.case_data)),
                ('resource2data', models.FileField(blank=True, null=True, upload_to=users.models.case_data)),
                ('resource3data', models.FileField(blank=True, null=True, upload_to=users.models.case_data)),
                ('resource4data', models.FileField(blank=True, null=True, upload_to=users.models.case_data)),
                ('resource5data', models.FileField(blank=True, null=True, upload_to=users.models.case_data)),
                ...
                ('core1', models.IntegerField(blank=True, default=0, null=True)),
                ('question2', models.CharField(blank=True, default='', max_length=500, null=True)),
                ('core2', models.IntegerField(blank=True, default=0, null=True)),
                ('question3', models.CharField(blank=True, default='', max_length=500, null=True)),
                ('core3', models.IntegerField(blank=True, default=0, null=True)),
                ('question4', models.CharField(blank=True, default='', max_length=500, null=True)),
                ('core4', models.IntegerField(blank=True, default=0, null=True)),
                ('question5', models.CharField(blank=True, default='', max_length=500, null=True)),
                ('core5', models.IntegerField(blank=True, default=0, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(default='', max_length=10)),
                ('logo', models.ImageField(blank=True, default='default/new_logo.png', null=True, upload_to=users.models.upload_loction_college)),
            ],
        ),
        migrations.CreateModel(
            name='interests',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('email', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to=settings.AUTH_USER_MODEL)),
                ('label', models.CharField(default='', max_length=50)),
                ('degree', models.CharField(choices=[('B.COM', 'B.COM'), ('BBA', 'BBA'), ('BMS', 'BMS')], default='', max_length=100)),
                ('college', models.CharField(default='', max_length=150)),
